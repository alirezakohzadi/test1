...
import vitaplexBanner from '../assets/images/vitaplex_hairloss_banner_1785871459662.jpg';
import goldenOfferBanner from '../assets/images/new_arrival_beauty_vertical_1785871427714.jpg';
  ...
  return (
    <section className="w-full mb-8">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        {/* Top Banner for Vitaplex Hair Strengthening */}
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          onClick={() => onNavigateCategory?.('vitaplex-hairloss')}
          className="w-full aspect-[16/5] sm:aspect-[4/1] rounded-xl sm:rounded-2xl overflow-hidden mb-5 group cursor-pointer relative"
        >
          <img
            src={vitaplexBanner}
            alt="ویتابلکس - سیستم تخصصی ضد ریزش و تقویت مو"
        ...
        {loading ? (
          ...
          <div className="flex flex-row gap-2.5 sm:gap-4 items-stretch">
            ...
            <div 
              ...
              onClick={() => onNavigateCategory?.('فرصت-طلایی')}
            >
              <img
                src={goldenOfferBanner}
                alt="پیشنهادات طلایی - Luxury Deals"
                referrerPolicy="no-referrer"

...
import sunsafeBanner from '../assets/images/banners/new-arrivals-wide-01.jpg';
import hydrodermEssenceBanner from '../assets/images/banners/new-arrivals-wide-02.jpg';
import newArrivalVerticalBanner from '../assets/images/banners/new-arrivals-vertical-01.jpg';
  ...
  return (
    <section className="w-full py-6 mb-8">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        {/* Top Banner 1: SunSafe Maquisun */}
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          onClick={() => onNavigateCategory?.('sunsafe-maquisun')}
        ...
        >
          <img
            src={sunsafeBanner}
            alt="ضد آفتاب کرم پودری سان سيف"
        ...
        <div className="mb-5 bg-slate-50/70 p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-100/90 shadow-2xs">
          <div className="mb-3.5 border-b border-slate-200/80 pb-2.5 flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              ...
              <h2 className="text-base sm:text-lg font-black text-[#0D7366]">جدیدترین محصولات</h2>
            </div>
          ...
          {loading ? (
            ...
            /* Slider + Vertical Poster Grid */
            <div className="flex flex-row gap-2.5 sm:gap-4 items-stretch">
              {/* Vertical Poster Banner (Beauty Reimagined) */}
              <motion.div
              ...
              >
                <img
                  src={newArrivalVerticalBanner}
                  alt="New Arrival Beauty Reimagined"
                  referrerPolicy="no-referrer"
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          onClick={() => onNavigateCategory?.('hydroderm-essence')}
        ...
        >
          <img
            src={hydrodermEssenceBanner}
            alt="بادی میست هیدرودرم اسنس"
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
          />
        </motion.div>

...
import bestsellerVerticalBanner from '../assets/images/banners/bestsellers-vertical-01.jpg';
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        {loading ? (
          ...
          <div className="flex flex-row gap-2.5 sm:gap-4 items-stretch">
            ...
            <div
              onClick={() => onNavigateCategory?.('best-sellers')}
            ...
            >
              <img
                src={bestsellerVerticalBanner}
                alt="پرفروش‌ترین محصولات"
